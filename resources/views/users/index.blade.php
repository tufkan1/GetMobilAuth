            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-12 col-lg-auto mb-8 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        <img src="https://ui-avatars.com/api/?background=random&amp;bold=true&amp;background=E1F1F9&amp;color=000&amp;name={{ $user->name }}" class="d-inline-flex flex-shrink-0 align-items-center justify-content-center me-4 rounded-2 bg-primary-light text-primary" style="width: 48px; height: 48px;" />
                        <div>
                            <p class="mb-0 text-dark">{{ $user->name }}</p>
                            <p class="mb-0 text-dark">{{ $user->department?->name }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-12 mt-8 mt-xl-0 col-xl-auto d-flex flex-row">
                    <a class="btn btn-outline-light d-inline-flex align-items-center justify-content-center p-0 me-2 shadow rounded-2" href="{{ route("users.edit", $user) }}" style="width: 40px; height: 40px;">
