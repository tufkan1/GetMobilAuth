            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-12 col-lg-auto mb-8 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        <img src="https://ui-avatars.com/api/?background=random&amp;bold=true&amp;background=E1F1F9&amp;color=000&amp;name={{ $role->name }}" class="d-inline-flex flex-shrink-0 align-items-center justify-content-center me-4 rounded-2 bg-primary-light text-primary" style="width: 48px; height: 48px;" />
                        <div>
                            <p class="mb-0 text-dark">{{ $role->name }}</p>
                        </div>
                        <p class="mb-0 ms-4 text-info">{{ $role->description }}</p>
                    </div>
                </div>
                <div class="col-12 col-lg-12 mt-8 mt-xl-0 col-xl-auto d-flex flex-row">
                    <a class="btn btn-outline-light d-inline-flex align-items-center justify-content-center p-0 me-2 shadow rounded-2" href="{{ route("roles.edit", $role) }}" style="width: 40px; height: 40px;">
